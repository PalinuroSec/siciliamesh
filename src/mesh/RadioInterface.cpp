...
const RegionInfo regions[] = {
    ...
    */
     ...
     */
    RDEF(EU_433, 433.0f, 434.0f, 100, 0, 20, true, false, false),
     ...
     */
    RDEF(EU_868, 869.4f, 869.65f, 100, 0, 20, false, false, false),
...
void RadioInterface::applyModemConfig()
{
    ...
    if ((power == 0) || !devicestate.owner.is_licensed)
        power = myRegion->powerLimit;

    if (power == 0)
        power = 20; // Default to this power level if we don't have a valid regional power limit (powerLimit of myRegion defaults
